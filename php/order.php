    ...
    <section class="information2">
        ...
        <?php foreach ($items as $item) { ?>
            <ul class="igroup2">
                ...
                <li>
                    <p><?= htmlspecialchars($item['name']) ?><br><span class="c_n"><?= htmlspecialchars($item['model']) ?></span></p>
                    <ul class="ig2_1">
                        <li>
     ...
     <div class="information5">
         <ul>
            ...
            <li>
                ...
                <label for="agree2">단순 변심으로 인한 교환/반품의 경우 반품 배송비가 발생할 수 있음을 확인했습니다.</label>
            </li>
            <li>
                <input type="checkbox" id="agree3">
                <label for="agree3">주문 정보를 확인했으며 이에 동의합니다.</label>
            </li>
         </ul>
     </div>
